...
from petcompanyblog.blog_posts.forms import BlogPostForm
...
def update_post(blog_post_id):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('blog_posts.blog_post', blog_post=blog_post_id))
    
    elif request.method=='GET':
        blog_post.title = form.title.data
        blog_post.text = form.title.data
        db.session.commit()
